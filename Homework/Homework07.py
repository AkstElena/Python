...
def count_syllables(object):
    count = 0
    syllables = ["а", "у", "о", "ы", "и", "э", "я", "ю", "ё", "е"]
    for item in object:
...
result = list(map(lambda x: count_syllables(x), text.lower().split()))
...
# operation = print_operation_table(lambda x, y: x * y, 6, 6)
